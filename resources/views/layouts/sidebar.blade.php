    ...
    <aside class="sidebar">
        <div class="sidebar-header">
            <h4><i class="fas fa-hospital"></i> HMS</h4>
            <small>Hospital Management</small>
        </div>
        <ul class="sidebar-menu">
            <li><a href="/adminhome" class="active"><i class="fas fa-chart-line"></i> Dashboard</a></li>
            <li><a href='/admin-department'><i class="fas fa-building"></i> Departments</a></li>
